...
INSERT INTO auth_role VALUES (1,'SUPER_USER','ultimate rights for everything');
INSERT INTO auth_role VALUES (2,'ADMIN_USER','admin rights for administrative work');
INSERT INTO auth_role VALUES (3,'SITE_USER','access to site, after login - normal user');
...
insert into auth_user (auth_user_id,first_name,last_name,email,password,status) values (1,'SS','Tim','ss@gmail.com','$2a$10$DD/FQ0hTIprg3fGarZl1reK1f7tzgM4RuFKjAKyun0Si60w6g3v5i','VERIFIED');
insert into auth_user (auth_user_id,first_name,last_name,email,password,status) values (2,'SS','Tim','ss@gmail.com','abc123ABC','VERIFIED');
